        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs/5 opacity-90">Browse, search, and manage issued credentials.</p>
            </div>
          </div>
      ...
      <section className="mt-6 rounded-2xl border border-gray-100 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="relative w-full md:max-w-sm">
            ...
            <input className="w-full rounded-lg border border-gray-200 pl-9 pr-3 py-2 text-sm dark:border-slate-800 dark:bg-slate-900/70 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-[#3E4095]" placeholder="Search credentials..." />
          </div>
          <div className="flex items-center gap-2">
            ...
            <button className="inline-flex items-center gap-2 rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 dark:border-slate-800 dark:text-slate-300 dark:hover:bg-slate-900">Type <ChevronDown className="h-4 w-4" /></button>
          </div>
        </div>
          ...
          <table className="min-w-full text-sm">
            <thead>
              <tr className="text-left text-gray-500 dark:text-slate-400">
                ...
                <th className="hidden px-3 py-2 font-medium sm:table-cell">Recipient</th>
                <th className="hidden px-3 py-2 font-medium sm:table-cell">Issued</th>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
              {["Blockchain 101", "AI Fundamentals", "Web3 Advanced"].map((name, i) => (
                <tr key={name} className="text-gray-700 dark:text-slate-300">
                  ...
                  <td className="hidden px-3 py-2 sm:table-cell">user{i+1}@example.com</td>
                  <td className="hidden px-3 py-2 sm:table-cell">2025-10-0{i+1}</td>
                  <td className="px-3 py-2">
                    {i === 0 && <span className="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2 py-0.5 text-xs text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-300"><CheckCircle2 className="h-3.5 w-3.5" /> Issued</span>}
