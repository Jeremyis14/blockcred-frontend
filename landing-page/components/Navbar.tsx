  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 transition-shadow duration-200 ${
        scrolled ? "shadow-md" : ""
      } bg-white/90 dark:bg-slate-950/80 backdrop-blur-md border-b border-transparent dark:border-slate-800`}
    >
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex items-center h-16">
          ...
          <div className="flex items-center flex-1 gap-3">
            ...
            >
              <span className="relative grid overflow-hidden rounded-lg h-9 w-9 place-items-center">
                <span className="absolute inset-0 rounded-lg bg-gradient-to-br from-[#3E4095]/20 to-[#5a57d9]/25 blur-sm" />
                <Image
                  src="/darkicon.png"
                  alt="BlockCred"
                  width={36}
              ...
              <span className="hidden text-sm font-extrabold tracking-widest text-gray-900 dark:text-white sm:inline-block">
                BLOCKCRED
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center justify-end flex-1 gap-3">
            ...
            <Link
              href="/login"
              className="relative items-center hidden px-4 py-2 overflow-hidden text-sm font-medium text-white rounded-full shadow-sm sm:inline-flex"
              onClick={onLinkClick}
            >
              <span
            ...
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-md text-gray-700 dark:text-slate-300 transition hover:bg-gray-100 dark:hover:bg-slate-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#3E4095]/40 md:hidden"
            >
              <svg
      ...
      >
        <div className="relative">
          <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-white/90 to-white dark:from-slate-950/80 dark:to-slate-950" />
                ...
                >
                  {item.href.startsWith('#') ? (
                    <a
                      ...
                      className="group block rounded-lg px-3 py-3 text-base font-medium text-gray-800 dark:text-slate-200 transition hover:bg-gray-50 dark:hover:bg-slate-800 active:scale-[0.99]"
                    >
